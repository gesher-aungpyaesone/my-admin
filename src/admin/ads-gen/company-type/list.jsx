...
export const CompanyTypeList = () => {
  ...
  return (
    <List
      actions={<ListActions />}
      title="resources.ads-company-type.list"
      filter={filters}
    >
      {isSmall ? (
        <SimpleList
        ...
        <DatagridConfigurable>
          ...
          <DateField
            ...
            label="resources.ads-company-type.fields.created_at"
            showTime
            sortBy="created_at"
          ...
          <DateField
            ...
            label="resources.ads-company-type.fields.updated_at"
            showTime
            sortBy="updated_at"
            transform={(value) => new Date(value * 1000)}
          />
